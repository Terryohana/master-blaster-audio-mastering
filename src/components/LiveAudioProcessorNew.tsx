      ...
      {audioFile && (
        <div className="space-y-6">
          ...
          <div className="bg-black p-4 rounded border border-gray-700 sticky top-4 z-10">
            ...
            {/* Rest of the meter code remains the same */}
          </div>

          {/* EQ Sliders and other controls remain the same */}
          ...
          <div className="flex justify-center gap-4">
            ...
            {/* CHANGE 4: Only show Process & Download button when project is saved */}
            {currentProjectId && (
              <button
